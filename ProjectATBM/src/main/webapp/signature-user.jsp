	...
	<div class="bg-login">
		<div class="container login pt-5">
			<div class="card mx-auto ">
				<div class="card-header text-center fw-bold">Ký xác nhận người dùng</div>
				<div class="card-body">
					<form action="sign-user" method="post">
						...
						<div class="form-group mt-2 mb-2">
							<label class="mb-2"><small>Email address</small> </label> 
							<input type="email" name="sign-email" class="form-control" placeholder="Enter email" value="${email}">
						</div>
						...
						<c:choose>
		                  	<c:when test="${hasSign == true}"> 
		                  		<div class="form-group mt-4 mb-2">
									...
									<input type="text" name="sign-signature" class="form-control" placeholder="Signature"
										value="${signature}">
								</div>
		                  	...
		                  	<c:otherwise>
			                  	<div class="form-group mt-4 mb-2">
									...
									<input type="text" name="sign-key" class="form-control" placeholder="Private key"
										value="${key}">
								</div>
